...
class influxdb (
  ...
  $initialization_join_urls             = $influxdb::params::initialization_join_urls,
  $broker_dir                           = $influxdb::params::broker_dir,
  $broker_port                          = $influxdb::params::broker_port,
  $cluster_port                         = $influxdb::params::cluster_port,
  ...
  $raft_tracing                         = $influxdb::params::raft_tracing,
